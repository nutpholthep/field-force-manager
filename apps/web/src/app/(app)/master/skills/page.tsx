...
export default function MasterSkillsPage() {
  ...
  const handleImport = async (records: Partial<Skill>[]) => {
    for (const r of records) await entities.Skill.create(r);
    queryClient.invalidateQueries({ queryKey: ['skills'] });
      ...
      <div className="flex flex-wrap gap-3 items-center justify-between">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          <MasterToolbar
            ...
            onImport={(records) => handleImport(records as unknown as Partial<Skill>[])}
          />
          {categories.length > 0 && (
            <select
              value={catFilter}
