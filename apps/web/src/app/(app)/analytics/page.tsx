...
import { Clock, DollarSign, Target, Award } from 'lucide-react';
...
export default function Analytics() {
  ...
  const { data: technicians = [], isLoading: techLoading } = useQuery<Technician[]>({
  ...
  const byServiceType = useMemo(() => {
    ...
    workOrders.forEach((wo) => {
      const type = (wo.service_type as string) || 'other';
