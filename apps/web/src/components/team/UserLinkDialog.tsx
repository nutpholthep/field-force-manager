...
import type { Technician, User } from '@ffm/shared';
...
export default function UserLinkDialog({ open, onClose, onSelect, currentLinkedId }: Props) {
  ...
  const linkedUserIds = new Set(
    technicians
      .filter(t => t.linked_user_id && t.linked_user_id !== currentLinkedId)
      .map(t => t.linked_user_id as string)
  );
