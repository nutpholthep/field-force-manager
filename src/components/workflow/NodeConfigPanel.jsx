...
export default function NodeConfigPanel({ node, technicians, zones, onClose, onChange }) {
    ...
    <div className="w-72 border-l border-slate-200 bg-white flex flex-col overflow-y-auto shrink-0">
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <Select value={node.assignee_mode || "manual"} onValueChange={v => update({ assignee_mode: v })}>
